...
import { HandCoins, PiggyBank, Briefcase, Landmark, Loader2 } from "lucide-react";
...
const AllocationCard = ({ title, amount, percentage, icon: Icon, color, isLoading }: AllocationCardProps) => (
...
export function IncomeAllocationDashboard({ totalIncome, isLoading }: { totalIncome: number; isLoading?: boolean }) {
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>
            ...
            {isLoading && <span className="text-xs text-muted-foreground ml-2">(กำลังโหลดอัตราแลกเปลี่ยน...)</span>}
        </CardDescription>
      </CardHeader>
      <CardContent>
