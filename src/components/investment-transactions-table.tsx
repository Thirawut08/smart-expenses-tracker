      ...
      <Table className="bg-transparent">
        ...
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="sticky left-[50px] bg-transparent z-10 min-w-[150px]">
              บัญชี
            </TableHead>
            ...
            <TableHead className="text-right min-w-[120px]">
              เทียบเท่า (THB)
              {isRateLoading && (
                <span className="text-xs font-normal ml-1">(loading...)</span>
              )}
            </TableHead>
        ...
        <TableBody>
          {transactions.map((transaction) => {
            ...
            const amountInThbFormatted = thbFormatter.format(
              transaction.type === "income" ? amountInTHB : -amountInTHB,
            );
            ...
            return (
              <TableRow key={transaction.id}>
                ...
                >
                  {isRateLoading && transaction.account.currency === "USD" ? (
                    <Skeleton className="h-5 w-24 float-right" />
                  ) : (
