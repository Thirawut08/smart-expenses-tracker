      ...
      <TableBody>
        {incomes.map((income) => (
          <TableRow key={income.id}>
            <TableCell>{format(income.date, 'd MMM yyyy, HH:mm', { locale: th })}</TableCell>
            <TableCell>
            ...
            <TableCell className="text-center">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem onClick={() => onDelete(income.id)} className="text-red-600 focus:text-red-600">
